...
def main():
    ...
    file_path = '/Users/janestrada/Library/Mobile Documents/com~apple~CloudDocs/Desktop/SorelleSummerResearch/TestHarness/dataframes/df_aggregated_spc.csv'
    ...
    ros_fet_path = '/Users/janestrada/Library/Mobile Documents/com~apple~CloudDocs/Desktop/SorelleSummerResearch/TestHarness/dataframes/subset_rosetta_features.csv'
    spc_fet_path = '/Users/janestrada/Library/Mobile Documents/com~apple~CloudDocs/Desktop/SorelleSummerResearch/TestHarness/dataframes/entropy_features.csv'
    ...
    print()
    th = TestHarness(output_location='/Users/janestrada/Library/Mobile Documents/com~apple~CloudDocs/Desktop/SorelleSummerResearch/TestHarness')
             
    models_to_be_used = [(keras_classification_4,'discreet'), (decision_tree_classification,'discreet'),
    ...
    for i,j in models_to_be_used:
        ...
        if i==keras_classification_4 or i==decision_tree_classification:
            continue 
